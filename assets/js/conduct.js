...
function h2TitleDivCreator(titleText, id, className) {
    ...
    contentDiv.className = "title-div";

    contentDiv.appendChild(h2);
    contentDiv.appendChild(underlineSpan);

    return contentDiv;
}


function h4TitleDivCreator(titleText, id, className) {
...
function renderconductSection() {
    ...
    const h2 = h2TitleDivCreator("Code of Conduct", "code-title", "events-title");
    const h4Security = h4TitleDivCreator("Security and expected behaviour during virtual events and workshops", "code-security-h4", "events-title");
    const h4Unexpected = h4TitleDivCreator("Unexpected behaviour and forms of harassment and discrimination", "code-unexpected-h4", "code-unexpected-h4");
    const h4Consequence = h4TitleDivCreator("Consequences for Harassment and Discrimination", "code-consequence-h4", "code-consequence-h4");
    const h4Report = h4TitleDivCreator("How to Report Harassment and Discrimination", "code-report-h4", "code-report-h4");
